...
import { isOpenAICodexWebSearchModel } from "./models.ts";
...
export const WEB_SEARCH_PARAMS = Type.Object({
	query: Type.String({
		minLength: 1,
...
export type WebSearchParams = Static<typeof WEB_SEARCH_PARAMS>;
...
export async function runProviderWebSearch(
	model: Model<Api>,
	query: string,
